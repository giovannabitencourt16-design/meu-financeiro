...
function tab(t) {
    ...
    registerTab.classList.toggle("active", !l);

    loginForm.classList.toggle("hidden", !l);
    registerForm.classList.toggle("hidden", l);
}
...
registerForm.onsubmit = async e => {
    ...
    try {
        ...
        const n = registerName.value.trim();
